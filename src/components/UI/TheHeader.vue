  ...
  <header class="header">
    <div class="logo">
      <div class="svg-center">
        <!-- IHU LOGO SVG -->
        <svg xml:space="preserve" width="50" height="50" version="1.1" style="
    ...
    <div class="mobile-logo">
      ...
      <div>
        <!-- IHU LOGO SVG -->
        <svg xml:space="preserve" width="50" height="40" version="1.1" style="
                  shape-rendering: geometricPrecision;
                  text-rendering: geometricPrecision;
                  image-rendering: optimizeQuality;
                  fill-rule: evenodd;
        ...
        <div style="cursor: pointer" class="logout-btn svg-center" v-if="isLoggedIn" @click="logOut">
          ...
          <v-tooltip text="Αποσύνδεση" location="bottom">
            <template v-slot:activator="{ props }">
              <!-- LOGOUT SVG -->
              <svg v-bind="props" width="30" height="30" viewBox="0 0 24 24">
