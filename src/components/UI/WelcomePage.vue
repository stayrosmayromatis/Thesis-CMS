    ...
    <div class="container" @click="emitMobileViewClose">
        ...
        <div class="main">
            ...
            <div class="main-content">
                <p>Η υπηρεσία αναπτύχθηκε στα πλαίσια εκπόνησης πτυχιακής εργασίας.</p>
                <p>Σκοπός,η ευχρηστία και η καλύτερη οργάνωση στις περιόδους δηλώσεις εργαστηρίων τόσο για φοιτητές, όσο και για καθηγητές.</p>
            </div>
